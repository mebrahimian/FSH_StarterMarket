...
const sortOptions: Array<{
  ...
  { value: "publishDateTime", label: "Publish date" },
  { value: "sentDateTime", label: "Sent date" },
  { value: "tracingNo", label: "Tracing number" },
  { value: "symbol", label: "Symbol" },
  { value: "companyName", label: "Company" },
  { value: "salesParsedAt", label: "Parse date" },
];
  ...
  const query = useQuery({
    ...
    queryFn: () =>
      searchDisclosures({
        ...
        let: toOptionalNumber(letFilter),
...
function FilterRow({
  ...
  return (
    <div className="flex flex-wrap items-center gap-2">
      <div className="flex h-8 items-center gap-2 rounded-full border border-[var(--color-border)] bg-[var(--color-card)] px-3">
        ...
        <Input
          ...
          value={rt}
          onChange={(event) =>
            onRtChange(event.target.value)
          }
          className="h-6 w-14 border-0 px-1 text-center font-mono text-[12px] shadow-none focus-visible:ring-0"
          aria-label="RT filter"
        />
      </div>
      ...
      <div className="flex h-8 items-center gap-2 rounded-full border border-[var(--color-border)] bg-[var(--color-card)] px-3">
        ...
        <Input
          ...
          value={letValue}
          onChange={(event) =>
            onLetChange(event.target.value)
          }
          className="h-6 w-14 border-0 px-1 text-center font-mono text-[12px] shadow-none focus-visible:ring-0"
          aria-label="LET filter"
        />
      </div>
