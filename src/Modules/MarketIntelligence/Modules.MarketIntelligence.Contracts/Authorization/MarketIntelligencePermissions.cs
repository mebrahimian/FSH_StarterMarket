...
public static class MarketIntelligencePermissions
{
    ...
    public static class CodalOperations
    {
        public const string Resource = "MarketIntelligence.CodalOperations";

        public const string Execute = $"Permissions.{Resource}.Execute";
    }
    ...
    [
        ...
        new(
            "Execute Codal operations",
            "Execute",
            CodalOperations.Resource)
    ];
}